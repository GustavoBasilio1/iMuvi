...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        String tbl_movie_drop = "DROP TABLE IF EXISTS " + MOVIE_TABLE_NAME + ";";

        String tbl_ratings_drop = "DROP TABLE IF EXISTS " + RATINGS_TABLE_NAME + ";";
        String tbl_bests_drop = "DROP TABLE IF EXISTS " + BESTFILM_TABLE_NAME + ";";

        db.execSQL(tbl_bests_drop);
        db.execSQL(tbl_ratings_drop);
        db.execSQL(tbl_movie_drop);
        onCreate(db);
    }
    ...
    public String addMovie(Movie movie){
        ...
        values.put(COLUMN_TOTALSEASONS, movie.getTotalseasons());
    ...
    Movie buscaMovie(String idimdb){
        ...
        Cursor cursor=db.query(MOVIE_TABLE_NAME,
                ...
                COLUMN_BOXOFFICE, COLUMN_PRODUCTION, COLUMN_WEBSITE, COLUMN_TOTALSEASONS},
